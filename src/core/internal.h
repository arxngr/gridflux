...
int find_maximized_ws_index (gf_win_info_t *windows, uint32_t count,
                              gf_handle_t handle);
...
void minimize_workspace_windows (gf_wm_t *m, gf_ws_id_t ws_id,
                                  gf_handle_t exclude_id,
                                  gf_monitor_id_t active_monitor);
void move_window_to_workspace (gf_wm_t *m, gf_win_info_t *win,
                                gf_ws_id_t new_ws_id);
void restore_workspace_windows (gf_wm_t *m, gf_ws_id_t ws_id,
