...
gf_error_code_t
gf_workspace_list_add (gf_workspace_list_t* list,
  ...
  if (list->count >= list->capacity)
    {
      ...
      gf_workspace_info_t* new_items = gf_realloc (
	  list->items, new_capacity * sizeof (gf_workspace_info_t));
      if (!new_items)
	return GF_ERROR_MEMORY_ALLOCATION;
...
gf_workspace_info_t*
gf_workspace_list_find (const gf_workspace_list_t* list,
