...
// Constants
#define GF_MAX_WINDOWS_PER_WORKSPACE 8
#define GF_MAX_WORKSPACES 32
#define GF_DEFAULT_PADDING 5
#define GF_MIN_WINDOW_SIZE 100
...
typedef enum {
  ...
  GF_GEOMETRY_CHANGE_ALL =
      (GF_GEOMETRY_CHANGE_X | GF_GEOMETRY_CHANGE_Y | GF_GEOMETRY_CHANGE_WIDTH |
       GF_GEOMETRY_CHANGE_HEIGHT)
} gf_geometry_flags_t;
